...
public partial class LicenseDialog : DialogRoot
{
    ...
    {
        GetDialogArgument("LicenseDialog");
    ...
    private static Dictionary GetLicenceDictinary()
    {
        Dictionary dic = new()
        {
            ...
            { "宇宙から来たメイド vs 鋼鉄の帝国", "常識の範囲でお使いください。" }
        };
    ...
    private static Dictionary GetCopyrightInfo(string name)
    {
    ...
    private void ShowTargetFiles(Dictionary target)
    {
        if (target.ContainsKey("files") && target["files"].VariantType is Variant.Type.Array)
        {
            ...
            SetTextEdit(_files, JoinString(files));
        }
        else
        {
            _files.Text = "";
    ...
    private void ShowTargetCopyright(Dictionary target)
    {
        if (target.ContainsKey("copyright") && target["copyright"].VariantType is Variant.Type.Array)
        {
            ...
            SetTextEdit(_copyright, JoinString(copyrights));
        }
        else
        {
            _copyright.Text = "";
    ...
    private void ShowLicense()
    {
        ...
        switch (_name)
        {
            ...
            case "宇宙から来たメイド vs 鋼鉄の帝国":
                ...
                _licenseList.Disabled = true;
                _licenseList.Clear();
                SetTextEdit(_licenseText, _licenseDictionary["宇宙から来たメイド vs 鋼鉄の帝国"].AsString());
